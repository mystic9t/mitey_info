    ...
    <footer className="sticky bottom-0 z-40">
      <div className="bg-india-green text-white">
        <div className="container mx-auto px-4 py-2">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-1 sm:gap-2 text-xs sm:text-sm">
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 sm:w-6 sm:h-6 rounded bg-saffron flex items-center justify-center">
            ...
            <p className="text-white/80 text-center text-[10px] sm:text-xs">{t.tagline}</p>
            <p className="text-white/60 hidden sm:block text-xs text-right">{t.disclaimer}</p>
          </div>
        </div>
      </div>
